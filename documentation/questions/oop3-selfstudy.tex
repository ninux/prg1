...
\textit{After a ticket has been printed, could the value in the \lstinline{balance} field ever be set to a negative value by subtracting \lstinline{price} from it? Justify your answer. }
