...
\textit{Write a mutator method called \lstinline{setAge} that takes a single parameter of type \lstinline{int} and sets the value of a field called \lstinline{age}. }\\
