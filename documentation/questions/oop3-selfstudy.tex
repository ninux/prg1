...
\textit{Draw a picture of the form shown in Figure 2.3, representing the initial state of a \lstinline{Student} object following its construction, with the following actual parameter values: \\
