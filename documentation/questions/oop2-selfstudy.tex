...
\textit{Suppose that the class \verb?Pet? has a field called \verb?name? that is of type \verb?String?. Write an assignment in the body of the following constructor so that the \verb?name? field will be initialized with the value of the constructor's parameter. \\
